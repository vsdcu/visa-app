...
async function main() {
  ...
  try {
    ...
    const declinedResponse = await contract.submitTransaction('decline', 'VisaWorld', '00001', 'Org1MSP', 'Org3MSP', '2020-11-30'); // async approve(ctx, submitterOrg, applicationNumber, approvingMSP, previousMSP, approvingDateTime)
