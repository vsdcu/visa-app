 ...
 * 4. Construct request to decline visa application
...
async function main() {
  ...
  try {
    ...
    const declinedResponse = await contract.submitTransaction('decline', 'VisaWorld', '00001', 'Org1MSP', 'Org3MSP', '2024-05-01'); // async approve(ctx, submitterOrg, applicationNumber, approvingMSP, previousMSP, approvingDateTime)
...
main().then(() => {
  ...
  console.log('decline program complete.');

}).catch((e) => {

  console.log('decline program exception.');
  console.log(e);
  console.log(e.stack);
  process.exit(-1);
