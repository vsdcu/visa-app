...
async function main() {
  ...
  try {
    ...
    const historyChkResponse = await contract.submitTransaction('historycheckpass', 'VisaWorld', '00001', 'Org3MSP', 'Org2MSP', '2024-05-01'); // async historycheckpass(ctx, submitterOrg, applicationNumber, approvingOrgMSP, previousMSP, approvingDateTime)
